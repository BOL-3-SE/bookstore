    ...
    <div class="container mx-auto px-4 py-12">
      ...
      <div class="flex flex-wrap justify-between mb-8">
        ...
        <div class="w-full md:w-1/4 mb-6 md:mb-0">
          ...
          <p class="text-gray-400 mb-4">Creating amazing experiences since 2010</p>
        ...
        <div class="w-full md:w-1/4">
          ...
          <p class="text-gray-400 mb-4">Get the latest updates and news directly in your inbox.</p>
          <form class="flex flex-col sm:flex-row">
            <input
              type="email"
              placeholder="Your email"
              class="px-4 py-2 w-full sm:w-auto mb-2 sm:mb-0 rounded-l sm:rounded-r-none focus:outline-none text-gray-900"
            />
            <button
              type="submit"
              class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-r sm:rounded-l-none"
            >
              Subscribe
            </button>
          </form>
